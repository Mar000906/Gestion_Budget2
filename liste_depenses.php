...
$sql = "SELECT d.id, d.montant, d.date, c.nom_compte, sc.nom_sous_categorie, s.nom_source
        FROM depense d
        JOIN compte c ON d.compte_id = c.id
        JOIN sous_categorie sc ON d.sous_categorie_id = sc.id
